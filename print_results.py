...
def print_results(results_dic, results_stats_dic, model,print_incorrect_dogs = False, print_incorrect_breed = False):
    ...
    print("\nPercentage of Correctly Classified Dogs: {:.2f}%".format(results_stats_dic['pct_correct_dogs']))

    # Print percentage of correctly classified not-a-dog images
    print("Percentage of Correctly Classified Not-a-Dog Images: {:.2f}%".format(results_stats_dic['pct_correct_notdogs']))

    # Print percentage of correctly classified breeds
    print("Percentage of Correctly Classified Dog Breeds: {:.2f}%".format(results_stats_dic['pct_correct_breed']))

    # Print details of incorrectly classified dogs if requested
    ...
    if print_incorrect_breed and results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']:
        ...
        for key in results_dic:
            if sum(results_dic[key][3:]) == 2 and results_dic[key][2] == 1:
                print("Real: {:>26}   Classifier: {:>30}".format(results_dic[key][0], results_dic[key][1]))
